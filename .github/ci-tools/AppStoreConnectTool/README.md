...
Validation includes Apple field limits, including the 100 **UTF-8 byte** keyword limit. The
capture metadata must list exactly the configured screenshot locales, devices, scenes, and
expected total count. PNG count and portrait-iPhone/landscape-iPad orientation are independently
